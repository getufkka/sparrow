...
PACKAGES="ant autoconf automake avahi-daemon awesome beanstalkd curl debhelper default-jdk g++ gitk gnome irssi libcppunit-dev libreadline6 libreadline6-dev libtool python-setuptools redis-server rubygems screen strace tcpdump unzip zip zsh"
PREFIX=$HOME/prefix
