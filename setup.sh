...
PACKAGES="ant autoconf automake avahi-daemon awesome curl debhelper default-jdk g++ gitk gdm gnome-desktop-environment xorg xserver-xorg-core gnome irssi libcppunit-dev libncurses5 libncurses5-dev libreadline6 libreadline6-dev libtool python-setuptools redis-server rubygems screen strace tcpdump unzip zip zsh"
PREFIX=$HOME/sparrow
